        ...
        <DialogContent initialFocus={false} size="sm">
          <DialogHeader>
            <DialogTitle>
              ...
              <span>Delete {card.name}</span>
            </DialogTitle>
            <DialogDescription>
              Are you sure you want to delete this credit card? It hasn't been used yet.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent initialFocus={false} size="md">
        <DialogHeader>
          ...
          <DialogDescription>
            You are about to delete a credit card used in {transactionsCount} transaction(s). Transactions will remain intact.
          </DialogDescription>
        </DialogHeader>
