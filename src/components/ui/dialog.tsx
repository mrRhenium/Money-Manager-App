...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-[1200] bg-black/50 duration-100 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-[1200] flex flex-col w-full max-w-[calc(100%-1.5rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-popover text-sm text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none shadow-2xl overflow-hidden",
          MODAL_TOKENS.height,
          sizeClass,
          className
        )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[&_.ant-select]:!min-h-[40px] [&_.ant-select]:!h-10 [&_.ant-select]:!flex [&_.ant-select]:!items-center [&_.ant-select]:!px-3.5 [&_.ant-select]:!text-[length:var(--font-size-modal-input)]",
        ...
        "[&_.ant-select-selector]:!min-h-[40px] [&_.ant-select-selector]:!flex [&_.ant-select-selector]:!items-center [&_.ant-select-selector]:!px-3.5 [&_.ant-select-selector]:!text-[length:var(--font-size-modal-input)]",
